...
Start with the [Getting Started](vignettes/getting-started.Rmd) vignette
for the main data-preparation workflow. The package documentation is
organized around the main modeling tasks:
