...
The directory [`README.md`](README.md) indexes the diagnostic specifications.
The planned intensive-longitudinal extension is specified separately in
...
The independent Woody--Sadler reference validation and outer simulation study
remain part of the frozen cross-sectional PR. Do not duplicate them on this
planning branch; they should enter it through the post-merge rebase.
...
- `brms`;
- intensive longitudinal or repeated dyad-occasion data, whose future contract
  is in
  [`gaussian-ild-partner-dependence.md`](gaussian-ild-partner-dependence.md);
