...
## The ILD APIM: Two member-specific equations {.smaller}

For dyad $i$ at occasion $t$, superscripts $\mathrm{W}$ and $\mathrm{B}$
denote within-person and between-person components. Here, $X_{ri,t-1}$ is
previous-day perceived behavioral control and
$Y_{ri,t}=\log(\mathrm{MVPA}_{ri,t})$:
...
## Gender-specific parameters improve fit
...
- **Within persons:** For male outcomes, own perceived behavioral control one
  point above usual on the previous day corresponded to about 3.5% more MVPA;
  the same previous-day increase in the partner's perceived behavioral control
  corresponded to about 2.5% more
...
<!-- TODO: can probably be simplified and shortened. Answering the research
question, and visualizing the effects? -->
