...
<!-- TODO: can we also plot the intercept?? -->
...
Index time by the outcome day $t$. For self-efficacy $X_{ri,t-1}$ measured on
the previous day:
...
2. **Plan and report power:** use simulation matched to the complete planned
   model.
