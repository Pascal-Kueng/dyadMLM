...
<!-- TODO: can't we re-use the function we created earlier for the similarity plots?
And either way, we should use the same mahalanobis of 4 right? I change it
from 0 to 4-->
...
```{r}
performance::check_predictions(ild_apim_exchangeable_model)
```
