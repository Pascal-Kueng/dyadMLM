...
```{r}
#| code-line-numbers: "1-38|4-5|7-8|10-17|19-26|28-29|31-36|38"
#| output: false
...
ild_lag1_label_parameters <- graphics::par(col.lab = "transparent")
ild_apim_no_ar_lag1_test <- test_ild_lag1(
  ild_apim_no_ar_dharma,
  plot = TRUE
)
graphics::par(ild_lag1_label_parameters)
graphics::title(
  xlab = "Simulated values; red = observed; p < .001",
  ylab = "Frequency"
)
```
...
mean ratios (GMRs; representing multiplicative differences).
...
:::{.text-smaller}
**Within person:** Men’s MVPA was 3.5% higher when their own previous-day PBC was
one point above usual, and 2.5% higher when their partner’s was.

**Between persons:** There was no clear evidence of actor or partner
associations.
:::
