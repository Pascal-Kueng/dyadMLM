...
We set MVPA to `NA` on days with less than 10 hours of weartime, center
time between 0 and 1 (start to end of the study), and select the needed variables.
...
ild_apim_distinguishable_ar1_model <- update(
  ...
  . ~ . -
    (0 + .is_female + .is_male | couple_id:diaryday) +
    ar1(0 + .is_female:as.factor(diaryday) | couple_id) +
    ar1(0 + .is_male:as.factor(diaryday) | couple_id) +
    (0 + .is_female + .is_male | couple_id:diaryday)
)
