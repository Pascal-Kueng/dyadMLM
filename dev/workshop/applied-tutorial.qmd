...
<!-- TODO: should we insert a link with resources for cross-sectional and ILD
power analysis in each section, or maybe better in the final few slides that
...
<!-- TODO: add multilevelTools to the install packages function for the
...
<!-- TODO: should we briefly show the slides again with the measures? Just 5
seconds each. -->
...
<!-- TODO: We should also create an ILD version of that code for manual computation
of actor effects and link back and forth appropriately. Safe for unordered rows
and missing rows, but as clear and short as possible. -->
