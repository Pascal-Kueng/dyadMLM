...
- Added experimental predictive checks for response variances and
  ...
  or selected non-Gaussian responses, including ordinal, zero-inflated,
  and hurdle models. Checks and plots can be shown separately for each
  dyad composition. Printed checks list each observed summary with the
