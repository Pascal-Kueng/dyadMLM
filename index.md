...
Started](https://pascal-kueng.github.io/interdep/vignettes/getting-started.Rmd)
vignette for the main data-preparation workflow. The package
documentation is organized around the main modeling tasks:

| Vignette | Focus |
|----|----|
| [Getting Started](https://pascal-kueng.github.io/interdep/vignettes/getting-started.Rmd) | Data structure, validation, dyad compositions, generated columns, and basic preparation |
...
| [Dyad-Individual Model](https://pascal-kueng.github.io/interdep/vignettes/Dyad-Individual-Model.Rmd) | DIM predictor construction and APIM-DIM equivalence for exchangeable dyads |
