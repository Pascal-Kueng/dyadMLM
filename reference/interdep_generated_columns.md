...
APIM, DIM, and undirected DSM columns stored in an `interdep` attribute.
This is a derived lookup table; the model-specific metadata tables
remain the source records.
