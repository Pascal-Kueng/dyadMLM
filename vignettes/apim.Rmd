...
[@delrosarioPracticalGuideSpecifying2025]. For example, let $b_{actor}$ denote
the shared actor random slope and $b_{diff:actor}$ the corresponding
`.i_diff_*` random slope. The actor slopes for the members assigned `+1` and
`-1` are
