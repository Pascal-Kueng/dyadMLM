...
The two parameterizations require different generated columns, so we prepare
the same observations once as distinguishable and once as exchangeable:
...
The distinguishable model allows all fixed effects and both residual variances
to differ between female and male members:
