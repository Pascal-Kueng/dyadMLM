...
continue with the [Mixed-Composition APIM vignette](mixed-apim.html). For the
main data-preparation workflow, return to the
[Getting Started vignette](getting-started.html). For the alternative DIM
parameterization of exchangeable dyads, see the
[Dyad-Individual Model vignette](dim.html), or continue to the
