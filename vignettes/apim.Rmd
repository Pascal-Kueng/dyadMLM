...
```{r check-cross-apim, eval = has_glmmTMB, echo = -1, fig.width = 8, fig.height = 9, out.width = "100%", fig.alt = "Six predictive-check histograms. Member SDs and partner correlation are on the left; dyad-average and half-difference summaries are on the right. Red lines mark observed values."}
