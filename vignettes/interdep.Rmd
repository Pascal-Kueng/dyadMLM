...
This first unified ILD model keeps only composition-specific intercepts and
composition-specific fixed time slopes. Actor and partner predictor effects are
left out for now. Random time slopes are also omitted; with separate stable and
same-day dyadic covariance blocks, random time slopes add many weakly identified
parameters and are a likely first source of convergence problems.
...
As in the Gaussian unified ILD model, the mean model contains only
composition-specific intercepts and fixed time slopes. The dyadic random-effect
