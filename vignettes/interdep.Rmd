...
cross_distinguishable_data <- prepare_interdep_data(
  ...
  # here, communication_actor and communication_partner
...
cross_distinguishable_model <- glmmTMB(
  satisfaction ~ 
    ...
    .i_is_female_x_male_female:communication_actor + .i_is_female_x_male_male:communication_actor +
    
    # gender-specific slopes for communication partner effect (no main effect)
    .i_is_female_x_male_female:communication_partner + .i_is_female_x_male_male:communication_partner +
...
tweedie_distinguishable_model <- glmmTMB(
  physical_activity ~ 
    ...
    .i_is_female_x_male_female:motivation_actor + .i_is_female_x_male_male:motivation_actor +
    
    # gender-specific slopes for motivation partner effect
    .i_is_female_x_male_female:motivation_partner + .i_is_female_x_male_male:motivation_partner +
