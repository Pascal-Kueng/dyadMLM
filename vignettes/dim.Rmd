...
In a dataset with mixed dyad types, we have a couple of options, depending on
our goal.

For instance, we can filter dyads and keep only male-male and female-female
dyads. Currently, DIM only supports one type of exchangeable dyad,
so we would pool those like this:
