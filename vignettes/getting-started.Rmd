...
also remain dependent over time. The `glmmTMB` approach used here does not
directly support a dyadic residual VAR structure for modeling both partners'
...
the research question and the data [@hamakerCenterNotCenter2015;
...
Person-mean centering a lagged outcome can introduce Nickell bias, especially
when there are few occasions [@hamakerCenterNotCenter2015;
@nickellBiasesDynamicModels1981]. Refer to the DIM vignette for a fuller
discussion and fitted dynamic examples.
