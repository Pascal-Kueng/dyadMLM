...
[@kennyPartnerEffectsRelationship1999]. `add_apim_gmc_predictors = TRUE` keeps
the raw columns and adds `.provided_support_gmc` plus actor and partner variants,
centered over all retained non-missing source values. Mixed non-numeric
predictors remain raw and trigger one warning. With an intercept, use either the
raw or GMC actor-partner pair, not both.
