...
The generated `.dy_diff_assumed_exchangeable_arbitrary` contrast assigns `-1`
...
[`dyadMLM::exchangeable_rescov()`](../reference/exchangeable_rescov.html).
...
`.dy_diff_female_x_female_arbitrary`, which is `0` for all other compositions
...
can be tested with
[`dyadMLM::compare_dyad_models()`](../reference/compare_dyad_models.html); see
