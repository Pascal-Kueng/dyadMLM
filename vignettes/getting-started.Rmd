...
We validate and prepare the data with the function `interdep::prepare_interdep_data()`.
...
Refer to the [exchangeable APIM section](apim.html#the-cross-sectional-gaussian-exchangeable-apim)
...
[`interdep::exchangeable_rescov()`](../reference/exchangeable_rescov.html).
...
`interdep::prepare_interdep_data()` then returns lag-1 raw and within-person-centered actor
...
The [APIMs with Mixed Dyad Compositions vignette](mixed-apim.html) shows
...
can be tested with
[`interdep::compare_interdep_models()`](../reference/compare_interdep_models.html); see
