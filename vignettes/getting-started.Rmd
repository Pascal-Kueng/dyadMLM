...
Previously we treated all dyads in the same dataset as the same type of exchangeable
...
`female-male` with `male-male`, you could treat `female-male` as exchangeable:
