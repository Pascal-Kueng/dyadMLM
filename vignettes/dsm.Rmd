...
The curved arrow $\rho_{\mathrm{md}}$ is the scale-free correlation between the
outcome-mean residual and the outcome-difference residual. It is **not** the
female-male residual correlation $\rho_{\mathrm{FM}}$ from the APIM.
...
For this reason, a nonzero $\rho_{\mathrm{md}}$ indicates that the two roles have different
