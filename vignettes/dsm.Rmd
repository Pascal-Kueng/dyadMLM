...
In `dyadMLM`, use `model_type = "dim"` for this exchangeable model and reserve
...
For more detail on centering decisions, interpretation, and dynamic models,
refer to the DIM vignette.
