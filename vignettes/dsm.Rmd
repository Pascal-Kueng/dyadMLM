...
components fitted and interpreted in the APIM vignette.
...
[fitted APIM example](apim.html#member-specific-residual-ar1) for estimation
and interpretation of the same two AR components.
