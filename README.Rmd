...
Interdependence Model (APIM), Dyad-Individual Model (DIM), and 
...
| [Dyadic Score Model](https://pascal-kueng.github.io/interdep/articles/dsm.html) | DSM predictor and contrast construction, formulas, and a demonstration of APIM-DIM equivalence for distinguishable dyads |

For an in-depth tutorial covering data preparation and model fitting, but also
additional steps lik ediagnostics and assumption checks, see
