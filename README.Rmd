...
```{r cross-sectional-prep, fig.keep = 3, fig.width = 7, fig.height = 4.5, fig.alt = "Histogram of simulated partner correlations with the observed correlation marked in red and the middle 95 percent of simulations marked by dashed lines."}
library(dyadMLM)
...
The function draws six plots. Only the partner-correlation plot is shown here.
