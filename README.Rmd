...
1. (Data preparation and validation of dyadic data)[#data-prep]
2. (Post-estimation tools)[#post-estimation]
...
## 1. Data preparation and validation (#data-prep)
...
The [Getting Started Vignette](https://pascal-kueng.github.io/dyadMLM/articles/getting-started.html)

## 2. Post-estimatsion tools

Selected post-estimation tools currently include: 

- a function to compare compatible nested models
- back-transform exchangeable random-effect covariance structures described in 
  the [APIM Vignette](https://pascal-kueng.github.io/dyadMLM/articles/apim.html) 
  used to estimate exchangeable dyads into interpretable member-level quantities.
...
For an in-depth tutorial covering data preparation, APIM and DIM model fitting,
diagnostics, and assumption checks, see
...
<!-- TODO: add the summerschool slide deck pages (the overview) as the primary
tutorial thing using glmmTMB, and then this brms tutorial as a secondary 
ressource -->
