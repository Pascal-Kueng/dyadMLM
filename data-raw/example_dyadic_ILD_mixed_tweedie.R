# Example intensive longitudinal dyadic data with mixed dyad types and
# a Tweedie outcome.
#
# Adapted from:
...
#
# This uses the same mixed-composition longitudinal dyadic structure as
# example_dyadic_ILD_mixed. The outcome is semi-continuous and generated from
...
example_dyadic_ILD_mixed_tweedie <- dplyr::select(
  dplyr::mutate(
    panel,
...
example_dyadic_ILD_mixed_tweedie <- dplyr::arrange(
...
missing_support_rows <- sample(seq_len(nrow(example_dyadic_ILD_mixed_tweedie)), n_missing_support)
example_dyadic_ILD_mixed_tweedie$provided_support[missing_support_rows] <- NA_real_
...
available_rows <- setdiff(seq_len(nrow(example_dyadic_ILD_mixed_tweedie)), missing_support_rows)
nonresponse_rows <- sample(available_rows, n_nonresponse_rows)
example_dyadic_ILD_mixed_tweedie$provided_support[nonresponse_rows] <- NA_real_
example_dyadic_ILD_mixed_tweedie$physical_activity[nonresponse_rows] <- NA_real_

###############################################################################
### SAVE PACKAGE DATA
###############################################################################

usethis::use_data(example_dyadic_ILD_mixed_tweedie, overwrite = TRUE)
