...
generated_column_spec_lookup <- function() {
  tibble::tribble(
    ...
    "dim",            "predictor",    "raw",      "within_dyad_deviation",  "none",                       "within_dyad_deviation",    "none",            21L,          ".i_{pred}_within_dyad_dev",             "DIM within-dyad predictor deviation: person's difference from the dyad average",
    ...
    "dim",            "predictor",    "cwp",      "within_dyad_deviation",  "within_person",              "within_dyad_deviation",    "none",            23L,          ".i_{pred}_cwp_within_dyad_dev",         "DIM within-person within-dyad predictor deviation: person's momentary deviation from the dyad average",
    ...
    "dim",            "predictor",    "cbp",      "within_dyad_deviation",  "between_person_grand_mean",  "within_dyad_deviation",    "none",            25L,          ".i_{pred}_cbp_within_dyad_dev",         "DIM between-person within-dyad predictor deviation: person's stable difference from the dyad's usual level",
