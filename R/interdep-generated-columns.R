...
generated_column_spec_lookup <- function() {
  tibble::tribble(
    ...
    "apim",           "predictor",    "raw",      "actor",                  "none",                       "none",                     "none",            10L,          ".i_{pred}_raw_actor",                       "APIM actor predictor: actor's original predictor values",
    "apim",           "predictor",    "raw",      "partner",                "none",                       "none",                     "none",            11L,          ".i_{pred}_raw_partner",                     "APIM partner predictor: partner's original predictor values",
    ...
    "dim",            "predictor",    "raw",      "dyad_mean",              "none",                       "dyad_mean",                "grand_mean",      20L,          ".i_{pred}_raw_dyad_mean_gmc",               "DIM dyad-mean predictor: dyad's average predictor level, grand-mean centered",
    "dim",            "predictor",    "raw",      "within_dyad_deviation",  "none",                       "within_dyad_deviation",    "none",            21L,          ".i_{pred}_raw_within_dyad_deviation",       "DIM within-dyad predictor deviation: person's difference from the dyad average",
    ...
    "undirected_dsm", "outcome",      "raw",      "dyad_mean",              "none",                       "dyad_mean",                "none",            30L,          ".i_{out}_raw_dyad_mean",                   "DSM dyad-mean outcome: dyad's average outcome level",
    "undirected_dsm", "outcome",      "raw",      "within_dyad_deviation",  "none",                       "within_dyad_deviation",    "none",            31L,          ".i_{out}_raw_within_dyad_deviation",       "DSM within-dyad outcome deviation: person's difference from the dyad average"
  )
}
