...
generated_column_spec_lookup <- function() {
  tibble::tribble(
    ...
    "dim",            "predictor",    "raw",      "within_dyad_deviation",  "none",                       "within_dyad_deviation",    "none",            21L,          ".i_{pred}_within_dyad_dev",             "DIM within-dyad member-deviation predictor: member's difference from the dyad mean",
    ...
    "dim",            "predictor",    "cwp",      "within_dyad_deviation",  "within_person",              "within_dyad_deviation",    "none",            23L,          ".i_{pred}_cwp_within_dyad_dev",         "DIM within-person, within-dyad member-deviation predictor: member's momentary deviation from the dyad mean",
    ...
    "dim",            "predictor",    "cbp",      "within_dyad_deviation",  "between_person_grand_mean",  "within_dyad_deviation",    "none",            25L,          ".i_{pred}_cbp_within_dyad_dev",         "DIM between-person, within-dyad member-deviation predictor: member's stable difference from the dyad's usual level",
    ...
    "dsm",            "predictor",    "raw",      "dyad_difference",        "none",                       "dyad_difference",          "none",            21L,          ".i_{pred}_within_dyad_diff",            "DSM signed predictor difference: first declared role minus second declared role",
    ...
    "dsm",            "predictor",    "cwp",      "dyad_difference",        "within_person",              "dyad_difference",          "none",            23L,          ".i_{pred}_cwp_within_dyad_diff",        "DSM within-person signed predictor difference: first declared role minus second declared role",
    ...
    "dsm",            "predictor",    "cbp",      "dyad_difference",        "between_person_grand_mean",  "dyad_difference",          "none",            25L,          ".i_{pred}_cbp_within_dyad_diff",        "DSM between-person signed predictor difference: first declared role minus second declared role"
  )
}
