...
generated_column_spec_lookup <- function() {
  tibble::tribble(
    ...
    "temporal",       "predictor",    "cwp",      "temporal_component",      "within_person",              "none",                     "none",            8L,           ".i_*_cwp",                             "within-person temporal predictor components",
    "temporal",       "predictor",    "cbp",      "temporal_component",      "between_person_grand_mean",  "none",                     "none",            9L,           ".i_*_cbp",                             "between-person temporal predictor components, centred around grand mean of person means",
    "apim",           "predictor",    "raw",      "actor",                  "none",                       "none",                     "none",            10L,          ".i_*_raw_actor",                       "APIM raw actor predictors",
    "apim",           "predictor",    "raw",      "partner",                "none",                       "none",                     "none",            11L,          ".i_*_raw_partner",                     "APIM raw partner predictors",
    "apim",           "predictor",    "cwp",      "actor",                  "within_person",              "none",                     "none",            12L,          ".i_*_cwp_actor",                       "APIM within-person actor predictors",
    "apim",           "predictor",    "cwp",      "partner",                "within_person",              "none",                     "none",            13L,          ".i_*_cwp_partner",                     "APIM within-person partner predictors",
    "apim",           "predictor",    "cbp",      "actor",                  "between_person_grand_mean",  "none",                     "none",            14L,          ".i_*_cbp_actor",                       "APIM between-person actor predictors",
    "apim",           "predictor",    "cbp",      "partner",                "between_person_grand_mean",  "none",                     "none",            15L,          ".i_*_cbp_partner",                     "APIM between-person partner predictors",
    "dim",            "predictor",    "raw",      "dyad_mean",              "none",                       "dyad_mean",                "grand_mean",      20L,          ".i_*_raw_dyad_mean_gmc",               "DIM raw predictor dyad means, grand-mean centred",
    "dim",            "predictor",    "raw",      "within_dyad_deviation",  "none",                       "within_dyad_deviation",    "none",            21L,          ".i_*_raw_within_dyad_deviation",       "DIM raw predictor within-dyad deviations",
    "dim",            "predictor",    "cwp",      "dyad_mean",              "within_person",              "dyad_mean",                "none",            22L,          ".i_*_cwp_dyad_mean",                   "DIM shared momentary predictor deviations",
    "dim",            "predictor",    "cwp",      "within_dyad_deviation",  "within_person",              "within_dyad_deviation",    "none",            23L,          ".i_*_cwp_within_dyad_deviation",       "DIM person deviations from shared momentary predictor levels",
    "dim",            "predictor",    "cbp",      "dyad_mean",              "between_person_grand_mean",  "dyad_mean",                "none",            24L,          ".i_*_cbp_dyad_mean",                   "DIM shared usual predictor levels, centred across persons",
    "dim",            "predictor",    "cbp",      "within_dyad_deviation",  "between_person_grand_mean",  "within_dyad_deviation",    "none",            25L,          ".i_*_cbp_within_dyad_deviation",       "DIM person differences from dyad usual predictor levels",
    "undirected_dsm", "outcome",      "raw",      "dyad_mean",              "none",                       "dyad_mean",                "none",            30L,          ".i_*_raw_dyad_mean",                   "DSM raw outcome dyad means",
    "undirected_dsm", "outcome",      "raw",      "within_dyad_deviation",  "none",                       "within_dyad_deviation",    "none",            31L,          ".i_*_raw_within_dyad_deviation",       "DSM raw outcome within-dyad deviations"
  )
}
