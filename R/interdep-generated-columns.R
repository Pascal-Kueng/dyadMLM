...
generated_column_spec_lookup <- function() {
  tibble::tribble(
    ...
    "temporal",       "predictor",    "cwp",      "temporal_component",      "within_person",              "none",                     "none",            8L,           ".i_*_cwp",                             "within-person predictor: momentary deviations from each person's usual level",
    "temporal",       "predictor",    "cbp",      "temporal_component",      "between_person_grand_mean",  "none",                     "none",            9L,           ".i_*_cbp",                             "between-person predictor: stable differences from the average person's usual level",
    "apim",           "predictor",    "raw",      "actor",                  "none",                       "none",                     "none",            10L,          ".i_*_raw_actor",                       "APIM actor predictor: actor's original predictor values",
    "apim",           "predictor",    "raw",      "partner",                "none",                       "none",                     "none",            11L,          ".i_*_raw_partner",                     "APIM partner predictor: partner's original predictor values",
    "apim",           "predictor",    "cwp",      "actor",                  "within_person",              "none",                     "none",            12L,          ".i_*_cwp_actor",                       "APIM within-person actor predictor: actor's momentary deviations from their usual level",
