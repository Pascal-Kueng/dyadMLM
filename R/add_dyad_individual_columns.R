...
#'
#' Adds Dyad-Individual Model (DIM) style dyad-mean and individual-deviation
...
#' the grand mean of dyad means by DIM convention, while the individual-deviation
#' column is the person's deviation from the uncentered dyad mean.
#'
...
#'
#' @return An `interdep_data` object with dyad-mean and individual-deviation
